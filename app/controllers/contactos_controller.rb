class ContactosController < ApplicationController
  ...
  def create
    @contacto = Contacto.new(contacto_params)
      if @contacto.save
        redirect_to :back
        flash[:success] = "Gracias por enviar el mensaje."
      else
        redirect_to :root
        flash[:alert] = "El mensaje no pudo ser enviado ya que los campos solicitdos no fueron llenados."
      end
  end
  ...
  private
    ...
    def contacto_params
      params.require(:contacto).permit(:nombre, :correo_electronico, :telefono, :mensaje)
    end
end
